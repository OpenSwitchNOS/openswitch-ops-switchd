...
def test_sflow_ft_sampling_rate(topology, step):
    ...
    # Sampling on ingress and egress for two interfaces
    expected_samples = float(4.0 * 10000.0/2048.0 * (70.0/100.0))
    ...
    assert result['flow_count'] >= 10.0*expected_samples
    ...
    # We expect at least 70% flow packets at the collector
    # Sampling on ingress and egress for two interfaces
    expected_samples = float(4.0 * 10000.0/4096.0 * (70.0/100.0))
