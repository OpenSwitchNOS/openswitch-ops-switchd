...
bridge_init(const char *remote)
{
    ...
    ovsdb_idl_omit_alert(idl, &ovsrec_nexthop_col_other_config);
    ovsdb_idl_omit_alert(idl, &ovsrec_nexthop_col_external_ids);
#endif
    ...
    ovsdb_idl_omit(idl, &ovsrec_route_col_sub_address_family);
