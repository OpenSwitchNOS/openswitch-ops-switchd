 ...
 *
 * You can register the function as shown bellow:
 *
 * int register_callback_block(void (*)(void*)logical-switch_foo,
 *                              Block_ID blkId,
 *                              int priority);
 *
 * where:
 *   - logical-switch_foo: is the function pointer of the plugin.
